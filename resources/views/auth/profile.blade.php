                            ...
                            <div class="profile-desk">
                                ...
                                <table class="table table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" class="ng-binding">{!!$user->profiles->platform!!}</a></td>
                                    </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-condensed">
                                    ...
                                    <tr>
                                        <td><b>Phone</b></td><td class="ng-binding">{!!$user->profiles->phone!!}</td>
                                    </tr>
                                    
                                    <tr>
                                        <td><b>Facebook</b></td>
                                        <td><a href="#" class="ng-binding">{!!$user->profiles->fb_user!!}</a></td>
                                    </tr>

                                    <tr>
                                        <td><b>Twitter</b></td>
                                        <td><a href="#" class="ng-binding">{!!$user->profiles->twitter_user!!}</a></td>
                                    </tr>

                                    <tr>
                                        <td><b>GIthub</b></td>
                                        <td><a href="#" class="ng-binding">{!!$user->profiles->github_user!!}</a></td>
                                    </tr>
                   ...
                   <div id="edit-profile" class="tab-pane">
                            <div class="user-profile-content">
                                ...
                                <div class="form-group">
                                    ...
                                    {!!Form::select('platform', \App\Profile::$platform, \Auth::user()->profiles->platform ,array('class' => 'form-control'))!!}
                                </div><br>
