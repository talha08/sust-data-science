							...
							<div class="col-lg-12 col-md-12">
								...
								<div class="events-title-meta clearfix">
									...
									<div class="event-meta">
										<span class="event-from">Start - {!! \App\Project::fullDate($project->id,$project->created_at) !!}</span>
										@if($project->project_status ==0)
											<span class="event-divider">to</span>
											<span class="event-to">End  - {!! \App\Project::fullDate($project->id,$project->updated_at) !!}</span>
										@endif
