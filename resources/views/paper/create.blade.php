							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="panel-body">
									...
									<div class="form-group">
										...
										{!!Form::select('paper_supervisor', $teacher, '',array('class' => 'select2', 'autofocus'))!!}
									</div><br/>

									<div class="form-group">
										{!! Form::label('paper_author', 'Select Student* :', array('class' => 'col-md-2 control-label')) !!}
										{!!Form::select('paper_author', $students, '',array('class' => 'select2', 'autofocus'))!!}
									</div><br/>


									<div class="form-group">
										{!! Form::label('paper_url', 'Paper Url(optional) :', array('class' => 'control-label')) !!}<br/>
										{!!Form::text('paper_url', '',array('class' => 'form-control','placeholder' =>  'Paper title here'))!!}
									</div><br/>
